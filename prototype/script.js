(function() {
  const translations = {
    en: {
      ...
      hero_new_desc: 'Scene-level auto-run. Script/Image/TTS/Render are individually retryable.',
      btn_create_project: 'Start pipeline',
      hero_templates: 'Test',
      hero_templates_title: 'Run partial scenes in Test Mode',
      hero_templates_desc: 'Low-res, short length, minimal cost. Opens scene selector.',
      btn_browse: 'Run test',
      hero_recent: 'Retry',
      hero_recent_title: 'Regenerate failed scenes only',
      hero_recent_desc: 'See failure reasons → retry → replace manually if needed.',
      btn_continue: 'Retry',
      section_projects: 'Active pipelines',
      btn_view_all: 'View all',
      card1_eyebrow: 'Auto pipeline',
      card1_title: 'Nova Energy Launch',
      card1_desc: 'Scene-based auto-run with controllable Script/Image/TTS',
      ...
      card2_desc: 'Cost-minimized test · run selected scenes only',
      chip_script: 'Test Mode',
      meta_deadline: 'Due: Today 18:00',
      card3_eyebrow: 'Has failed scenes',
      card3_title: 'Product How-to',
      card3_desc: 'Inspect logs then retry/replace immediately',
    ...
    ko: {
      ...
      hero_new_desc: 'Scene 단위 자동 실행 · 대본/이미지/TTS/렌더를 각각 재시도 가능.',
      btn_create_project: '파이프라인 시작',
      hero_templates: '테스트',
      hero_templates_title: 'Test Mode로 일부 Scene만',
      hero_templates_desc: '저해상·짧은 길이로 비용 절감 · Scene 선택 화면 이동',
      btn_browse: '테스트 실행',
      hero_recent: '재시도',
      hero_recent_title: '실패 Scene만 다시 만들기',
      hero_recent_desc: '실패 원인 확인 → 재시도 → 직접 교체',
      btn_continue: '재시도',
      section_projects: '진행 중 파이프라인',
      btn_view_all: '전체 보기',
      card1_eyebrow: '자동 파이프라인',
      card1_title: 'Nova Energy Launch',
      card1_desc: 'Scene 기반 자동 실행 · 대본/이미지/TTS 제어 가능',
      chip_timeline: '자동화',
      ...
      card2_title: 'Travel Vlog Series',
      card2_desc: '비용 최소 테스트 · 일부 Scene만 생성',
      chip_script: 'Test Mode',
      meta_deadline: '마감: 오늘 18:00',
      card3_eyebrow: '실패 Scene 있음',
      card3_title: 'Product How-to',
      card3_desc: '원인 로그 확인 후 즉시 재시도/교체',
      chip_render: '재시도 필요',
      meta_queue: '대기열 2/5',
