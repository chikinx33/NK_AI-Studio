...
(function () {
  ...
  var DICT = {
    ko: {
      ...
      'hero.lead': '기획·글·이미지·영상·사운드 제작부터 여러 SNS 채널 배포와 성과 분석까지. 지시만 하면 담당 AI 직원이 실행하고, 배포·삭제 같은 되돌릴 수 없는 일은 <strong>당신 승인</strong> 뒤에만 움직입니다.',
      'hero.cta2': 'AI 직원 만나보기',
      'hero.trust1': '지시 → 실행 → 승인 → 배포 원스톱',
      'hero.trust2': '여러 SNS 채널 자동 게시 + 성과 자동 수집',
      ...
      'band.item3': '<b>멀티 채널</b> SNS 자동 배포',
      ...
      'pipe4.title': 'SNS 배포',
      'pipe4.desc': '채널별 캡션·해시태그를 정리해 여러 SNS에 한 번에 게시합니다.',
      'pipe5.title': '성과 분석',
      ...
      'feat8.desc': '여러 채널에 동시 게시하고 채널별 메타데이터를 자동 정리합니다.',
      ...
      'faq.a3': 'YouTube, Instagram, TikTok, Facebook, Threads, X 등을 지원합니다. 계정을 연결해 두면 한 번에 게시됩니다.',
    ...
    en: {
      ...
      'hero.lead': 'From planning, copy, image, video and sound to publishing across your social channels and reading the results. Give the instruction — the right AI teammate executes, and anything irreversible waits for your approval.',
      'hero.cta2': 'Meet the team',
      'hero.trust1': 'Instruct → execute → approve → publish',
      'hero.trust2': 'Auto-publish across your channels, auto-collect results',
      ...
      'band.item3': '<b>Multi-channel</b> publishing',
      ...
      'pipe4.title': 'Publish',
      'pipe4.desc': 'Captions and hashtags are formatted per channel and posted to every connected channel at once.',
      ...
      'tag.multiChannel': 'Multi-channel',
      ...
      'feat8.desc': 'Publish to every connected channel at once, with per-channel metadata handled automatically.',
      ...
      'an.p1': 'Auto-sync across connected channels',
      ...
      'faq.a3': 'YouTube, Instagram, TikTok, Facebook, Threads, X and more. Connect the accounts and publish to all of them at once.',
