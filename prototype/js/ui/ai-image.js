        ...
        ? '<div class="ai-image-preview-stage">' +
          ...
          '<div class="ai-image-preview-foot">' +
              ...
              '<div class="ai-image-preview-meta">' +
                ...
                '<p class="ai-image-preview-prompt"><button type="button" class="ai-image-analysis-btn" data-action="copy-result-prompt" data-id="' + escapeHtml(selectedResult ? selectedResult.id : '') + '" aria-label="' + escapeHtml(t('reusePrompt')) + '" title="' + escapeHtml(t('reusePrompt')) + '"><svg class="icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect width="14" height="14" x="8" y="8" rx="2" ry="2"></rect><path d="M4 16c-1.1 0-2-.9-2-2V4c0-1.1.9-2 2-2h10c1.1 0 2 .9 2 2"></path></svg></button> ' + escapeHtml(selectedResult ? (selectedResult.prompt || '') : (preview.name || '')) + '</p>' +
              '</div>' +
          '</div>' +
        '</div>'
