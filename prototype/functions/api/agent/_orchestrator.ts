...
export function buildAgentSystem(agentId: string, opts: BuildSystemOpts = {}): string {
  ...
  const TOOL_LABELS: Record<string, string> = {
    ...
    scene_shots: "씬→샷 분해", scene_locations: "장소 추출", story_structure: "스토리 구조 생성", scene_upsert: "씬 수정/추가", scene_reorder: "컷 순서 변경", scene_split: "씬 나누기/합치기", set_sheet: "세트 시트(바이블) 생성", location_merge: "장소(세트) 합치기", location_suggest: "같은 세트로 보이는 장소 제안",
