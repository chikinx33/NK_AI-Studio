...
- 각 Scene의 shot(시각 묘사)은 한 줄이지만 **장소/주피사체·행동/조명·카메라 앵글·구도·스타일 키워드**를 포함해 구체적으로 쓰고, 필요한 경우 “no text/no speech bubble” 등 부정을 함께 적으세요. shot에만 스타일을 반영하세요.
...
- Each shot must be one line but include **location, main subject/action, lighting, camera angle/composition, style cues**; add “no text/speech bubble” etc. inline when needed; apply style only in shot.
