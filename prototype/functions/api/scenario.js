...
- 각 Scene의 shot(시각 묘사)은 반드시 한 문장이고 다음 요소를 포함하세요:
  Subject & action; Location/Background; Lighting; Camera angle & framing; Style cues; (Constraints는 사용자가 제공한 경우에만 포함)
...
- Shot format (one sentence):
  Subject & action; Location/Background; Lighting; Camera angle & framing; Style cues; (Constraints only if user provided)
