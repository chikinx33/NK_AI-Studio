...
② CTA: 브랜드 상황에 맞는 구체적 행동 유도 (DM, 댓글, 공유 등 — 사용자가 설정하지 않은 기능 절대 언급 금지)
③ 질문: 팔로워가 실제로 답하고 싶어지는 구체적 질문 1개

레이어 3 — 핵심 해시태그 (필수)
- 3~5개만. 캡션 해시태그와 중복 금지. 마지막 줄에 배치
- 브랜드명·캐릭터명·제품명 또는 에피소드 핵심 키워드 위주

전체 길이: 3~5줄 이내. 브랜드 공식 계정이 다는 첫 댓글임을 의식하고 작성.

[출력 형식]
반드시 아래 JSON만 반환. 설명·마크다운 없이.
{"caption":"...","hashtags":"#태그1 #태그2 ...","first_comment":"..."}
`.trim(),
