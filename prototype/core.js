;(function () {
  ...
  core.translations = {
    en: {
      ...
      scenario_song_options_help: 'Lyrics become the subtitles, and the scenario is written from those lyrics together with the story. "Sung in" is the language the song is performed in.',
    ...
    ko: {
      ...
      scenario_song_options_help: '가사는 자막으로 쓰이고, 시나리오는 이 가사와 이야기를 함께 보고 씁니다. 언어는 노래를 부를 언어예요.',
