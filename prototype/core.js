;(function () {
  ...
  core.translations = {
    en: {
      ...
      '구독·API 설정': 'Subscription & API settings',
      ...
      '체크 해제: 마스터 설정 사용. 체크 후 인증을 설정하고 저장해 주세요.': 'Unchecked: use master settings. To use your account, check the box, set credentials and save.',
      '테마 선택': 'Theme presets',
      '다크': 'Dark',
      '라이트': 'Light',
