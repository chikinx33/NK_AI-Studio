;(function () {
  ...
  core.needsList = [
    '학습', '놀이', '엔터테인먼트', '스토리', '감성', '힐링', '공감', '생활 정보', '생산성',
    '자기계발', '진로', '커리어', '창업', '경제', '재테크', '소비', '노후 설계', '사회 이슈',
    '시사', '건강', '식습관', '여가', '취미', '여행', '스트레스', '멘탈 관리', '가정',
    '자녀', '연애', '라이프스타일', '광고'
  ];
  core.toneList = [
  ...
  core.styleList = [
    '실사(리얼리티)', '만화', '애니메이션', '일러스트', '모션그래픽', '인포그래픽', '슬라이드형', '스케치',
    '미니멀', '레트로', '시네마틱', '클레이(스톱모션)'
  ];
})(); 
