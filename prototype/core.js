;(function () {
  ...
  core.translations = {
    en: {
      ...
      admin_err_deletion_pending: 'This ID is awaiting deletion and cannot be registered again until cleanup finishes.',
      admin_deletion_pending: 'Deletion pending',
      admin_delete_scheduled: 'The account was disabled. Its data will be permanently deleted after the seven-day grace period.',
      admin_confirm_delete: 'Schedule this account for deletion? Sign-in and re-registration will be blocked immediately, and all account data will be permanently deleted after 7 days.',
      admin_delete_at: 'Scheduled:',
      admin_restore: 'Restore',
      admin_restoring: 'Restoring…',
      admin_confirm_restore: 'Restore this member? The deletion schedule will be cancelled and the account will become active again.',
      admin_restore_done: 'The deletion schedule was cancelled and the member account was restored.',
      admin_err_restore_fail: 'Restore failed',
      admin_err_restore_expired: 'The seven-day recovery window has expired and this account can no longer be restored.',
      admin_err_restore_not_pending: 'This account is no longer awaiting deletion. Refresh the list.',
      admin_perm_videogen: 'AI Video',
      admin_perm_image: 'AI Image',
      admin_perm_video: 'AI Cinema',
      admin_perm_brand: 'Brand Studio',
      admin_perm_doc: 'AI Doc',
      admin_perm_sound: 'AI Audio',
      ...
      nav_publish: 'Publish',
      sidebar_canvas_fixed: 'Canvas',
      sidebar_previz_fixed: 'Previz',
      dashboard_view_label: 'View',
      dashboard_view_card: 'Card view',
      dashboard_view_list: 'List view',
      dashboard_series_edit: 'Edit|project',
      dashboard_series_delete: 'Delete|series',
      dashboard_page_label: 'Pages',
      dashboard_page_prev: 'Prev',
      dashboard_page_next: 'Next',
      dashboard_series_select_hint: 'Select a series to rename or delete it',
      ...
      scenario_lyrics_ai_loading: 'Writing the lyrics...',
      ...
      scenario_song_options: 'Song options',
      scenario_song_lyrics_enabled: 'Lyrics',
      scenario_song_language: 'Sung in',
      scenario_song_language_ko: 'Korean',
      scenario_song_language_en: 'English',
      scenario_song_language_zh: 'Chinese',
      ...
      scenario_save: 'Save',
      scenario_redecompose: 'Re-cut shots',
      scenario_redecompose_hint: 'Keeps the story; rewrites each cut\'s composition, action, timeline and blocking with the latest rules. Press Save to keep the result.',
      ...
      '적용 후 연결 상태를 확인하세요': 'Apply to check the connection status',
      '인증을 등록해 주세요': 'Register your credentials',
      '연결 프로그램을 실행해 주세요': 'Start your connector',
      'Claude 인증 등록됨': 'Claude credentials registered',
      'ChatGPT 구독 연결 정상': 'ChatGPT subscription connected',
      'OpenAI API 키 등록됨': 'OpenAI API key registered',
      'API 연결': 'API Connection',
      'AI 채팅 — 내 구독·API 사용': 'AI chat — use my subscription/API',
      '이미지 생성 — 내 구독·API 사용': 'Image generation — use my subscription/API',
      'Claude 인증': 'Claude credentials',
      '이미지 인증': 'Image credentials',
      '내 ChatGPT 구독': 'My ChatGPT subscription',
      '내 OpenAI API 키': 'My OpenAI API key',
      '테마 선택': 'Theme presets',
      '다크': 'Dark',
      '라이트': 'Light',
      ...
      ai_doc_model_flare_hint: 'Fast · default',
      ai_doc_model_sunburst_hint: 'Precise · slower',
    ...
    ko: {
      ...
      admin_err_deletion_pending: '삭제 대기 중인 ID입니다. 정리가 끝날 때까지 다시 등록할 수 없습니다.',
      admin_deletion_pending: '삭제 대기',
      admin_delete_scheduled: '계정을 즉시 비활성화했습니다. 7일 유예기간이 지나면 모든 자료가 영구 삭제됩니다.',
      admin_confirm_delete: '이 계정을 삭제 대기로 전환할까요? 즉시 로그인과 재가입이 차단되며, 7일 후 계정의 모든 자료가 영구 삭제됩니다.',
      admin_delete_at: '삭제 예정:',
      admin_restore: '복구',
      admin_restoring: '복구 중...',
      admin_confirm_restore: '이 회원을 복구할까요? 삭제 예약이 취소되고 기존 회원 계정이 다시 활성화됩니다.',
      admin_restore_done: '삭제 예약을 취소하고 회원 계정을 정상 복구했습니다.',
      admin_err_restore_fail: '복구 실패',
      admin_err_restore_expired: '7일의 복구 가능 기간이 지나 더 이상 복구할 수 없습니다.',
      admin_err_restore_not_pending: '현재 삭제 대기 중인 계정이 아닙니다. 목록을 새로고침해 주세요.',
      admin_perm_videogen: 'AI 영상',
      admin_perm_image: 'AI 이미지',
      admin_perm_video: 'AI 시네마',
      admin_perm_brand: '브랜드 스튜디오',
      admin_perm_doc: 'AI 문서',
      admin_perm_sound: 'AI 오디오',
      ...
      nav_render: '결과 대기열',
      nav_publish: '배포',
      sidebar_canvas_fixed: '캔버스',
      sidebar_previz_fixed: '프리비즈',
      dashboard_view_label: '보기 방식',
      dashboard_view_card: '카드 보기',
      dashboard_view_list: '리스트 보기',
      dashboard_series_edit: '프로젝트|수정',
      dashboard_series_delete: '시리즈|삭제',
      dashboard_page_label: '페이지',
      dashboard_page_prev: '이전',
      dashboard_page_next: '다음',
      dashboard_series_select_hint: '시리즈를 선택하면 이름 변경/삭제를 할 수 있어요',
      sidebar_preproduction_fixed: 'Pre-Prod',
      sidebar_production_fixed: 'Production',
      sidebar_postproduction_fixed: 'Post-Prod',
      ...
      scenario_lyrics_ai_loading: '가사를 쓰는 중입니다...',
      scenario_story_required: '이야기를 먼저 입력해 주세요.',
      scenario_story_structure_failed: '이야기 정리 실패',
      scenario_genre: '장르',
      scenario_subgenre: '세부 장르',
      scenario_song_options: '노래 옵션',
      scenario_song_lyrics_enabled: '가사',
      scenario_song_language: '언어',
      scenario_song_language_ko: '한국어',
      scenario_song_language_en: '영어',
      scenario_song_language_zh: '중국어',
      ...
      scenario_reset: '초기화',
      scenario_save: '저장하기',
      scenario_redecompose: '컷 다시 나누기',
      scenario_redecompose_hint: '이야기는 그대로 두고, 지금 컷들의 화면·행동·타임라인·블로킹을 최신 규칙으로 다시 써요. 결과는 저장하기를 눌러야 남아요.',
      ...
      ai_doc_model_flare_hint: '빠름 · 기본',
      ai_doc_model_sunburst_hint: '정밀 · 느림',
