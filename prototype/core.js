;(function () {
  ...
  core.translations = {
    en: {
      ...
      scenario_topic_placeholder: 'Example: Shape Friends',
      scenario_genre: 'Genre',
      scenario_subgenre: 'Subgenre',
      scenario_target: 'Target audience',
      scenario_view_purpose: 'Viewing purpose',
      ...
      scenario_character_placeholder: 'Enter a character name and press Enter (example: Rabbit)',
      scenario_generation_options: 'Generation options',
      scenario_narration_enabled: 'Generate narration',
      scenario_dubbing_enabled: 'Generate dubbing (dialogue)',
      scenario_knowledge_hub: 'Knowledge Hub',
    ...
    ko: {
      ...
      scenario_topic: '주제',
      scenario_topic_placeholder: '예: 모양새 친구들',
      scenario_genre: '장르',
      ...
      scenario_character_placeholder: '캐릭터 이름 입력 후 Enter (예: 토끼)',
      scenario_generation_options: '생성 옵션',
      scenario_narration_enabled: '나레이션 생성',
      scenario_dubbing_enabled: '더빙(대사) 생성',
      scenario_knowledge_hub: '지식 허브',
      scenario_script: '대본',
