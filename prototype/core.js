;(function () {
  ...
  core.translations = {
    en: {
      ...
      scenario_lyrics_help: 'Keep the [Chorus] / [Verse 1] section markers - they are handed to the scenes in order. You can edit them freely.',
    ...
    ko: {
      ...
      scenario_lyrics_help: '[후렴] [1절] 같은 구간 표시를 그대로 두면 씬에 순서대로 배분돼요. 직접 고쳐도 됩니다.',
