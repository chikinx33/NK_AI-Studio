...
export const AGENT_VOICE_PRESETS: AgentVoicePreset[] = [
  { key: "voice-01", label: "ElevenLabs-01 (여성)", provider: "elevenlabs", providerVoiceId: "EXAVITQu4vr4xnSDxMaL", voiceId: "kr_female_narration", pitch: 0, speakingRate: 1, prompt: "ElevenLabs voice 01" },
  { key: "voice-02", label: "ElevenLabs-02 (남성)", provider: "elevenlabs", providerVoiceId: "pNInz6obpgDQGcFmaJgB", voiceId: "kr_male_narration", pitch: 0, speakingRate: 1, prompt: "ElevenLabs voice 02" },
  { key: "voice-03", label: "ElevenLabs-03 (여성)", provider: "elevenlabs", providerVoiceId: "21m00Tcm4TlvDq8ikWAM", voiceId: "kr_female_narration", pitch: 0, speakingRate: 1, prompt: "ElevenLabs voice 03" },
  { key: "voice-04", label: "ElevenLabs-04 (남성)", provider: "elevenlabs", providerVoiceId: "TxGEqnHWrfWFTfGW9XjX", voiceId: "kr_male_narration", pitch: 0, speakingRate: 1, prompt: "ElevenLabs voice 04" },
  { key: "voice-05", label: "ElevenLabs-05 (여성)", provider: "elevenlabs", providerVoiceId: "MF3mGyEYCl7XYWbV9V6O", voiceId: "kr_female_narration", pitch: 0, speakingRate: 1, prompt: "ElevenLabs voice 05" },
  { key: "voice-06", label: "ElevenLabs-06 (남성)", provider: "elevenlabs", providerVoiceId: "ErXwobaYiN019PkySvjV", voiceId: "kr_male_narration", pitch: 0, speakingRate: 1, prompt: "ElevenLabs voice 06" },
  { key: "voice-07", label: "ElevenLabs-07 (여성)", provider: "elevenlabs", providerVoiceId: "AZnzlk1XvdvUeBnXmlld", voiceId: "kr_female_narration", pitch: 0, speakingRate: 1, prompt: "ElevenLabs voice 07" },
  { key: "voice-08", label: "ElevenLabs-08 (남성)", provider: "elevenlabs", providerVoiceId: "yoZ06aMxZJJ28mfd3POQ", voiceId: "kr_male_narration", pitch: 0, speakingRate: 1, prompt: "ElevenLabs voice 08" },
  { key: "voice-09", label: "Gemini TTS-01 (남성)", provider: "gemini", geminiVoiceName: "Kore", voiceId: "kr_male_narration", pitch: -1, speakingRate: 1.02, prompt: "Speak as a calm Korean executive orchestrator. Warm, precise, and not robotic." },
  { key: "voice-10", label: "Gemini TTS-02 (남성)", provider: "gemini", geminiVoiceName: "Charon", voiceId: "kr_male_narration", pitch: -3, speakingRate: 1.0, prompt: "Speak as a confident Korean business strategist. Low, dry, practical, and human." },
  { key: "voice-11", label: "Gemini TTS-03 (남성)", provider: "gemini", geminiVoiceName: "Orus", voiceId: "kr_male_narration", pitch: -1, speakingRate: 1.04, prompt: "Speak as a precise Korean research analyst. Clear, factual, and lightly brisk." },
  { key: "voice-12", label: "Gemini TTS-04 (여성)", provider: "gemini", geminiVoiceName: "Aoede", voiceId: "kr_female_narration", pitch: 3, speakingRate: 1.08, prompt: "Speak as a bright Korean marketer. Friendly, energetic, and conversational." },
  { key: "voice-13", label: "Gemini TTS-05 (남성)", provider: "gemini", geminiVoiceName: "Puck", voiceId: "kr_male_narration", pitch: 1, speakingRate: 1.03, prompt: "Speak as a playful Korean story planner. Expressive, warm, and imaginative." },
  { key: "voice-14", label: "Gemini TTS-06 (여성)", provider: "gemini", geminiVoiceName: "Leda", voiceId: "kr_female_narration", pitch: 0, speakingRate: 0.98, prompt: "Speak as a thoughtful Korean writer. Soft, articulate, and restrained." },
  { key: "voice-15", label: "Gemini TTS-07 (남성)", provider: "gemini", geminiVoiceName: "Zephyr", voiceId: "kr_male_narration", pitch: 2, speakingRate: 1.07, prompt: "Speak as a lively Korean designer. Visual, upbeat, and natural." },
  { key: "voice-16", label: "Gemini TTS-08 (여성)", provider: "gemini", geminiVoiceName: "Callirrhoe", voiceId: "kr_female_narration", pitch: 2, speakingRate: 1.05, prompt: "Speak as a Korean sound producer. Smooth, rhythmic, and relaxed." },
  { key: "voice-17", label: "Gemini TTS-09 (남성)", provider: "gemini", geminiVoiceName: "Fenrir", voiceId: "kr_male_narration", pitch: -2, speakingRate: 1.01, prompt: "Speak as a calm Korean software engineer. Practical, concise, and steady." },
  { key: "voice-18", label: "Gemini TTS-10 (여성)", provider: "gemini", geminiVoiceName: "Autonoe", voiceId: "kr_female_narration", pitch: 3, speakingRate: 1.09, prompt: "Speak as a lively Korean PR lead. Social, quick, and encouraging." },
  { key: "voice-19", label: "Gemini TTS-11 (여성)", provider: "gemini", geminiVoiceName: "Despina", voiceId: "kr_female_narration", pitch: 1, speakingRate: 1.03, prompt: "Speak as a kind Korean operations assistant. Organized, gentle, and clear." },
  { key: "voice-20", label: "Gemini TTS-12 (여성)", provider: "gemini", geminiVoiceName: "Achernar", voiceId: "kr_female_narration", pitch: 1, speakingRate: 0.98, prompt: "Speak in warm natural Korean. Gentle, close, and reassuring." },
  { key: "voice-21", label: "Gemini TTS-13 (남성)", provider: "gemini", geminiVoiceName: "Alnilam", voiceId: "kr_male_narration", pitch: 0, speakingRate: 1.08, prompt: "Speak as a crisp Korean host. Clear, modern, and easy to follow." },
  { key: "voice-22", label: "Gemini TTS-14 (여성)", provider: "gemini", geminiVoiceName: "Vindemiatrix", voiceId: "kr_female_narration", pitch: -1, speakingRate: 0.96, prompt: "Speak as a soft Korean narrator. Natural, calm, and expressive." },
];
