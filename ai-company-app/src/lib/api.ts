...
export const AGENT_VOICE_PRESETS: AgentVoicePreset[] = [
  ...
  { key: "voice-09", label: "Gemini TTS-01", provider: "gemini", geminiVoiceName: "Kore", voiceId: "kr_male_narration", pitch: -1, speakingRate: 1.02, prompt: "Speak as a calm Korean executive orchestrator. Warm, precise, and not robotic." },
  { key: "voice-10", label: "Gemini TTS-02", provider: "gemini", geminiVoiceName: "Charon", voiceId: "kr_male_narration", pitch: -3, speakingRate: 1.0, prompt: "Speak as a confident Korean business strategist. Low, dry, practical, and human." },
  { key: "voice-11", label: "Gemini TTS-03", provider: "gemini", geminiVoiceName: "Orus", voiceId: "kr_male_narration", pitch: -1, speakingRate: 1.04, prompt: "Speak as a precise Korean research analyst. Clear, factual, and lightly brisk." },
  { key: "voice-12", label: "Gemini TTS-04", provider: "gemini", geminiVoiceName: "Aoede", voiceId: "kr_female_narration", pitch: 3, speakingRate: 1.08, prompt: "Speak as a bright Korean marketer. Friendly, energetic, and conversational." },
  { key: "voice-13", label: "Gemini TTS-05", provider: "gemini", geminiVoiceName: "Puck", voiceId: "kr_male_narration", pitch: 1, speakingRate: 1.03, prompt: "Speak as a playful Korean story planner. Expressive, warm, and imaginative." },
  { key: "voice-14", label: "Gemini TTS-06", provider: "gemini", geminiVoiceName: "Leda", voiceId: "kr_female_narration", pitch: 0, speakingRate: 0.98, prompt: "Speak as a thoughtful Korean writer. Soft, articulate, and restrained." },
  { key: "voice-15", label: "Gemini TTS-07", provider: "gemini", geminiVoiceName: "Zephyr", voiceId: "kr_male_narration", pitch: 2, speakingRate: 1.07, prompt: "Speak as a lively Korean designer. Visual, upbeat, and natural." },
  { key: "voice-16", label: "Gemini TTS-08", provider: "gemini", geminiVoiceName: "Callirrhoe", voiceId: "kr_female_narration", pitch: 2, speakingRate: 1.05, prompt: "Speak as a Korean sound producer. Smooth, rhythmic, and relaxed." },
  { key: "voice-17", label: "Gemini TTS-09", provider: "gemini", geminiVoiceName: "Fenrir", voiceId: "kr_male_narration", pitch: -2, speakingRate: 1.01, prompt: "Speak as a calm Korean software engineer. Practical, concise, and steady." },
  { key: "voice-18", label: "Gemini TTS-10", provider: "gemini", geminiVoiceName: "Autonoe", voiceId: "kr_female_narration", pitch: 3, speakingRate: 1.09, prompt: "Speak as a lively Korean PR lead. Social, quick, and encouraging." },
  { key: "voice-19", label: "Gemini TTS-11", provider: "gemini", geminiVoiceName: "Despina", voiceId: "kr_female_narration", pitch: 1, speakingRate: 1.03, prompt: "Speak as a kind Korean operations assistant. Organized, gentle, and clear." },
  { key: "voice-20", label: "Gemini TTS-12", provider: "gemini", geminiVoiceName: "Achernar", voiceId: "kr_female_narration", pitch: 1, speakingRate: 0.98, prompt: "Speak in warm natural Korean. Gentle, close, and reassuring." },
  { key: "voice-21", label: "Gemini TTS-13", provider: "gemini", geminiVoiceName: "Alnilam", voiceId: "kr_male_narration", pitch: 0, speakingRate: 1.08, prompt: "Speak as a crisp Korean host. Clear, modern, and easy to follow." },
  { key: "voice-22", label: "Gemini TTS-14", provider: "gemini", geminiVoiceName: "Vindemiatrix", voiceId: "kr_female_narration", pitch: -1, speakingRate: 0.96, prompt: "Speak as a soft Korean narrator. Natural, calm, and expressive." },
];
